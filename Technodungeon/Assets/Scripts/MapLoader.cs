...
public class MapLoader : MonoBehaviour 
{
    ...
    public bool generateTilePrefabsFromFile = false;  // generates Tile prefabs from a given parent prefab with all possible components. Only works in Editor, useful to update Scenery Prefabs - just edit the 00 prefab and run this.
    ...
    public void parseBlocks() {
        ...
        foreach (char c in blocks) {
            ...
            if (c == '{') {
                ...
                if (generateBlockPrefabsFromFile) {
...
*/
    ...
    public void loadTiles(List<Tile> tilePool, string path) {
        ...
        foreach (GameObject tile in tilez) {
            ...
            if (generateTilePrefabsFromFile && i == 0 && tile.name.Contains ("_00")) {
            ...
            if (generateTilePrefabsFromFile && i == 1 && tile.name.Contains ("_01")) {
        ...
        if (generateTilePrefabsFromFile && masterParentFloorPrefab != null && masterParentCeilingPrefab != null) {
