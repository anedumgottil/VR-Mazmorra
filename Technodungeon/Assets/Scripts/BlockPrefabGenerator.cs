...
public class BlockPrefabGenerator {
    ...
    //if the prefab game object for this block has already been created, just returns the prefab. TODO: It doesn't "just return the prefab"
    //otherwise, creates it, then returns the prefab. Now you can make 10000000s of blocks! (well not really, but you get the idea)
